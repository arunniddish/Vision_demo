...
%         m = str2double(m_char);
        ...
        if m>=3  % Check this properly and needs to be changed if needed.
            ...
            dx(i) = abs(centroid1(count,1) - centroid1(count-1,1));
            Td_int = round(Td_int + G*(abs(centroid1(count,1) - centroid1(count-1,1))));
