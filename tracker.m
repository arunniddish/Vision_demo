% This is a code to track magenta color.  Finds and annotates centroid and bounding box of magenta blobs.
...
hThresholds = [0.910, 0.955];
sThresholds = [0.753, 0.956];
vThresholds = [1, 5];
