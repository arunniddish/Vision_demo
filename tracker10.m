...
baseFileName = 'Inchworm_2_Left_only.mp4';  % Video to track
...
pix2mm = 0.608;  % This is only for this particular video. Should be updated for different videos
...
figure(3)
imshow(thisFrame);
title('Left tendon Only', 'FontSize', fontSize);
hold on
